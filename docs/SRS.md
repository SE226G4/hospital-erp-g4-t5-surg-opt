...
#### A. Class Diagram
![Class Diagram لقسم الجراحة](../class_Diagram.drawio (1).png)
...
### 6.3 System Integration & Data Flow (تكامل المخططات مع متطلبات الفريق)
تم بناء الـ ERD والـ Class Diagram ليتوافقا بشكل كامل مع مخرجات الموديول:
* **تكامل مع قيود رغد (Section 4):** يعكس مخطط الكلاسات ومخطط الكيانات وجود حقول مخصصة لوقت التعقيم الإلزامي `Buffer Time` لمنع تضارب المواعيد برمجياً.
* **تكامل مع واجهات مريم (Section 5):** تضمن العلاقات المرسومة في الـ ERD انسياب البيانات بشكل صحيح من واجهة المستخدم إلى الجداول المركزية للمستشفى دون تكرار.
