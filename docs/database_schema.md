# Database Schema & Process Modeling - Module 5 (Surgical Optimization)
**(Lilas Hamadah & Raghad Brejawi)**

## 1. Entity-Relationship Diagram (ERD)(lilas Hamadah)

* **الأداة المستخدمة:** Draw.io
* **رابط تعديل المخطط على Draw.io:**(https://app.diagrams.net/#G1yZqmGC88vFT4IEP5lTKCrpYUxhzKq57N#%7B%22pageId%22%3A%22wWFlRW2iCIbDgGKqphHK%22%7D)
* **رابط تعديل مخطط الأصناف (Class Diagram):**](https://app.diagrams.net/#G1yZqmGC88vFT4IEP5lTKCrpYUxhzKq57N#%7B%22pageId%22%3A%22wWFlRW2iCIbDgGKqphHK%22%7D)
...
* **اسم الجدول:** SurgicalBookings
* **وصف الهدف من الجدول:** الجدول الأساسي والمحوري للموديول، ويقوم بتخزين كافة بيانات حجوزات العمليات الجراحية، المواعيد، وحالة الحجز، ومعرفات الفريق الطبي المشرف.
